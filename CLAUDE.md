...
- **`MobileTabBar`** (`src/components/layout/MobileTabBar.tsx`) below 900px — four tabs plus a central `+` that opens the palette. There is no burger, drawer or edge-swipe any more; below 900px the sidebar is not rendered at all
