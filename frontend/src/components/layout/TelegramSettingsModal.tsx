  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Telegram напоминания" maxWidth="md">
      <div className="space-y-4">
        {isLoading ? (
          <p className="text-sm text-fg-mid">Загрузка...</p>
        ) : connected ? (
          ...
          <div className="space-y-3">
            <div className="p-3 bg-bg-cell border border-line">
              <p className="text-sm text-fg font-medium mb-1">Как подключить:</p>
              <ol className="text-sm text-fg-body space-y-1 list-decimal list-inside">
                <li>Откройте бота в Telegram</li>
                <li>Отправьте команду <code className="bg-bg-hover px-1">/start</code></li>
